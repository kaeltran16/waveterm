...
// renderer) has no unit harness here. Behavior is covered by the Task 5 CDP visual check (hunk/file
// completion settle).
// See docs/superpowers/specs/2026-07-04-files-diff-motion-design.md.
