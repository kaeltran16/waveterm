    ...
    return (
        <section className="mb-[28px] mt-[8px]">
            <div className="mb-[13px] flex items-center gap-[10px] px-px">
                <div className="h-[8px] w-[8px] animate-[pulseDot_1.6s_infinite] motion-reduce:animate-none rounded-full bg-asking" />
                ...
                <span className="text-[11.5px] text-ink-faint">
                    harvested from your agents — keep what's worth remembering
                </span>
                        ...
                        >
                            <div className="min-w-0 flex-1">
                                <div className="mb-[5px] flex items-center gap-[8px]">
                                    <span
                                        className={cn(
                                            "flex-none rounded-[5px] px-[7px] py-[2px] font-mono text-[9px] font-semibold uppercase tracking-[0.05em]",
                                            m.pillClass
                                        )}
                                    ...
                                    <div className="flex-1" />
                                    {age && (
                                        <span className="flex-none font-mono text-[10.5px] text-ink-faint">{age}</span>
                                    )}
                                </div>
                                <div className="mb-[3px] line-clamp-1 text-[14px] font-semibold tracking-[-0.005em] text-ink-hi">
                                    {p.title}
                                </div>
                            ...
                            <div className="flex flex-none flex-col gap-[6px] self-center">
                                <button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        fireAndForget(() => keepPending(p.path));
                                    }}
                                ...
                                <button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        fireAndForget(() => dismissPending(p.path));
                                    }}
