                    ...
                    <>
                        ...
                        {model_.attention != null ? (
                            <button
                                ...
                                className="flex w-full cursor-pointer items-center gap-2 rounded-[10px] border border-asking/30 bg-asking/10 px-4 py-2.5 text-left transition-colors duration-[140ms] hover:bg-asking/15"
                            >
                                <span className="h-2 w-2 flex-none rounded-full bg-asking" />
                                <span className="text-[13px] font-semibold text-primary">
                                    Needs you · {model_.attention.count}
                                </span>
                            </button>
                        ) : null}
                        <div className="flex flex-col gap-4">
