...
// `done` on a neutral grey, a list of finished runs was four identical rows of it. `cancelled` was on
// ink-faint, the decorative tier, which measured 1.9:1 against the background.
...
export function RecordThread({ detail, model }: { detail: DossierDetail | null; model: AgentsViewModel }) {
    ...
    return (
        ...
        // centred column over a full-bleed activity list — a 414px jog at the divider.
        <div className={cn(STAGE_SCROLLER, "min-h-0 flex-1")}>
            <div className={cn(STAGE_GUTTER, "flex flex-col gap-3.5 pb-2.5 pt-4")}>
