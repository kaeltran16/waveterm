...
export class RpcApiType {
    ...
    // command "dagaction" [call]
    DagActionCommand(client: WshClient, data: CommandDagActionData, opts?: RpcOpts): Promise<void> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "dagaction", data, opts);
    ...
    DagMergeCommand(client: WshClient, data: CommandDagMergeData, opts?: RpcOpts): Promise<void> {
        ...
        return client.wshRpcCall("dagmerge", data, opts);
    }

    // command "dagmergecontinue" [call]
    DagMergeContinueCommand(client: WshClient, data: CommandDagMergeData, opts?: RpcOpts): Promise<void> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "dagmergecontinue", data, opts);
    ...
    GitDivergenceCommand(client: WshClient, data: CommandGitDivergenceData, opts?: RpcOpts): Promise<CommandGitDivergenceRtnData> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "gitdivergence", data, opts);
        return client.wshRpcCall("gitdivergence", data, opts);
    }

    // command "gitfetch" [call]
    GitFetchCommand(client: WshClient, data: CommandGitFetchData, opts?: RpcOpts): Promise<CommandGitFetchRtnData> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "gitfetch", data, opts);
        return client.wshRpcCall("gitfetch", data, opts);
    }

    // command "gitfileatref" [call]
    GitFileAtRefCommand(client: WshClient, data: CommandGitFileAtRefData, opts?: RpcOpts): Promise<CommandGitFileAtRefRtnData> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "gitfileatref", data, opts);
        return client.wshRpcCall("gitfileatref", data, opts);
    }
    ...
    JarvisRunEventsCommand(client: WshClient, data: CommandJarvisRunEventsData, opts?: RpcOpts): Promise<CommandJarvisRunEventsRtnData> {
        ...
        return client.wshRpcCall("jarvisrunevents", data, opts);
    }
    ...
    // command "memoryarchive" [call]
    MemoryArchiveCommand(client: WshClient, data: CommandMemoryArchiveData, opts?: RpcOpts): Promise<void> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "memoryarchive", data, opts);
        return client.wshRpcCall("memoryarchive", data, opts);
    }
    ...
    // command "memorystats" [call]
    MemoryStatsCommand(client: WshClient, opts?: RpcOpts): Promise<CommandMemoryStatsRtnData> {
        if (this.mockClient) return this.mockClient.mockWshRpcCall(client, "memorystats", null, opts);
        return client.wshRpcCall("memorystats", null, opts);
    }
