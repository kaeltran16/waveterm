...
- **Frontend — React 19 + Vite + Tailwind 4 + jotai (`frontend/`)** — `frontend/tauri/main.tsx` is the
  ...
  their labels: `files` renders as "Diff", `vault` replaced Memory, `code` is the ninth; the order is
