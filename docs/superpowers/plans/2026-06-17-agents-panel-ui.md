...
- `docs/superpowers/specs/assets/2026-06-17-agents-panel/01-locked-design-sidebar-and-view.html` (primary — sidebar launcher + view together)
- `docs/superpowers/specs/assets/2026-06-17-agents-panel/02-agents-view-fullscreen.html` (the view at scale)
- Spec: `docs/superpowers/specs/2026-06-17-agents-panel-design.md` (see "UI reference" + §4 layout, §5 data flow, §6 payload).
