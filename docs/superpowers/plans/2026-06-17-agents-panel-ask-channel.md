...
> **Superseded by Plan 3c** (`docs/superpowers/plans/2026-06-17-agents-panel-organic-ask-hook.md`) — the blocking `ask_human` MCP tool was replaced by a PreToolUse hook on `AskUserQuestion`. Retained as design history.
...
**Source of truth:** spec `docs/superpowers/specs/2026-06-17-ask-human-channel-design.md` (Approach A, decided with the user 2026-06-17). Builds on Plan 3a (`docs/superpowers/plans/2026-06-17-agents-panel-live-roster.md`), which already ships `AgentAsk`, `AgentVM.ask`, and the `AskCard`'s conditional pills/reply branch.
