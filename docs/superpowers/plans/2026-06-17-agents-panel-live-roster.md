...
**Source of truth:** spec `docs/superpowers/specs/2026-06-17-agents-panel-design.md` §5.1 (roster from `agentstatusstore`), §5.3/§10.1 (previous-info projection — shipped Plan 2), §5.5 (idle straggler / peek), §10.3 (live working line vs on-demand previous-info), §10.4 (asking as a status). Builds directly on Plan 2 (`docs/superpowers/plans/2026-06-17-agents-panel-previous-info.md`).
