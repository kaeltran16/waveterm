...
**Tech Stack:** Go (wshrpc streaming RPC, `fsnotify`), TypeScript/React, Jotai atoms, vitest, Go `testing`. Spec: `docs/superpowers/specs/2026-06-19-agents-tab-triage-design.md`. Visual source of truth: `docs/superpowers/specs/assets/2026-06-19-agents-tab-triage/`.
...
Start a Claude agent in a project, open the Agents tab. Verify against mockup 01 (`docs/superpowers/specs/assets/2026-06-19-agents-tab-triage/01-full-height-output.html`):
