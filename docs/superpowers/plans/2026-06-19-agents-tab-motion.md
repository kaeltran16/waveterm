...
**Tech Stack:** TypeScript/React 19.2, Jotai, Tailwind v4, Vite 6, `motion` (added in Task 1), vitest. Spec: `docs/superpowers/specs/2026-06-19-agents-tab-answering-layout-motion-design.md` §7.
