...
**Source of truth:** spec `docs/superpowers/specs/2026-06-17-agents-panel-design.md` §5.3 (projection), §10.1 (resolved approach), §7 (transcript-unreadable path). Render contract `AgentEntry` is defined in `frontend/app/view/agents/agentsviewmodel.ts` (Plan 1) and is **unchanged** here.
