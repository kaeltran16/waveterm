...
**Date:** 2026-09-09
**Status:** B1, B2 and B3 built; B3 wave 2 is not yet live-verified (see the tracking table). Design settled in the mockups. B4–B5 are built from this file directly.
